...
- The client that serves every circuit: [The embedded Tor client](tor-client.md).
- Why there's no onion path any more: [The relay's Tor exit path](tor-exit.md).
